  ...
  ['app'],
  {
        ...
        s = {
          ...
          mutations: {
            TOGGLE_SIDEBAR: function (t) {
              t.sidebar.opened
                ? r.a.set('sidebarStatus', 1)
                : r.a.set('sidebarStatus', 0),
        ...
        d = {
          ...
          actions: {
            Login: function (t) {
              var e = t.commit,
                n =
                  'eyJhbGciOiJIUzUxMiIsInppcCI6IkdaSVAifQ.H4sIAAAAAAAAAKtWKi5NUrJSCjAK0A0Ndg1S0lFKrShQsjI0tTQxNjEzsDTWUSotTi3yTAGKQZh-ibmpQB2mpkq1AIWfmDc-AAAA.ddyVa47OQ9Ny9m226KoZjWKwGJzxg2kiy8ngEL9YsaHXR31lK8Vnla5DZBlV6m0-T7ujyiu7VhNaUERbJUAxTA'
              Object(u.c)(n), e('SET_TOKEN', n)
            },
            GetInfo: function (t) {
              var e = t.commit,
                n = { roles: ['admin'], name: 'zc' }
              n.roles && n.roles.length > 0 && e('SET_ROLES', n.roles),
                e('SET_NAME', n.name),
                e('SET_AVATAR', n.avatar)
            },
            LogOut: function (t) {
              var e = t.commit
              t.state
    ...
    Vtdi: function (t, e, n) {
      ...
      var i = n('Kw5r'),
        ...
        r = (n('D66Q'), n('8NkQ')),
        s = n.n(r),
        c = (n('sg+I'), n('LDq6'), n('aMui'), { name: 'App' }),
        l = n('KHd+'),
        u = Object(l.a)(
          c,
          function () {
        ...
        g = {
          ...
          methods: {
            getBreadcrumb: function () {
              ...
              e &&
                'dashboard' !== e.name &&
                (t = [{ path: '/dashboard', meta: { title: '首页' } }].concat(
                  t
                )),
                (this.levelList = t)
            },
                ...
                [
                  n(
                    ...
                    t._l(t.levelList, function (e, i) {
                      return e.meta.title
                        ? n('el-breadcrumb-item', { key: e.path }, [
                            'noredirect' === e.redirect ||
                            i == t.levelList.length - 1
      ...
      var z = {
          ...
          render: function (t, e) {
            var n = e.props,
              ...
              o = []
            return (
              i && o.push(t('svg-icon', { attrs: { 'icon-class': i } })),
              a && o.push(t('span', { slot: 'title' }, [a])),
              o
            )
          },
        },
        B = Object(l.a)(z, void 0, void 0, !1, null, null, null)
          ...
          methods: {
            ...
            linkProps: function (t) {
              return this.isExternalLink(t)
                ? { is: 'a', href: t, target: '_blank', rel: 'noopener' }
                : { is: 'router-link', to: t }
            },
          },
        },
      ...
      var H = {
          name: 'SidebarItem',
          components: { Item: V, AppLink: L.exports },
          props: {
          ...
          methods: {
            ...
            resolvePath: function (t) {
              return this.isExternalLink(t) ? t : A.a.resolve(this.basePath, t)
            },
            isExternalLink: function (t) {
              return S(t)
            },
        ...
        I = Object(l.a)(
          ...
          function () {
            var t = this,
              e = t.$createElement,
              n = t._self._c || e
            return !t.item.hidden && t.item.children
              ? n(
                  'div',
                  { staticClass: 'menu-wrapper' },
                  [
                    !t.hasOneShowingChild(t.item.children, t.item) ||
                    (t.onlyOneChild.children &&
                      !t.onlyOneChild.noShowingChildren) ||
                    t.item.alwaysShow
                      ? n(
                          'el-submenu',
                          { attrs: { index: t.resolvePath(t.item.path) } },
                          [
                            n(
                              'template',
                              { slot: 'title' },
                      ...
                      : [
                          n(
                            'app-link',
                            {
                              attrs: { to: t.resolvePath(t.onlyOneChild.path) },
                            },
                            [
                              n(
                                'el-menu-item',
      ...
      D.options.__file = 'AppMain.vue'
      var F = D.exports,
        K = n('Q2AE'),
        P = document.body,
        U = {
          name: 'Layout',
          components: { Navbar: E, Sidebar: N, AppMain: F },
          mixins: [
            {
              watch: {
                $route: function (t) {
                  'mobile' === this.device &&
                    this.sidebar.opened &&
                    K.a.dispatch('CloseSideBar', { withoutAnimation: !1 })
                },
              },
              ...
              mounted: function () {
                this.isMobile() &&
                  (K.a.dispatch('ToggleDevice', 'mobile'),
                  K.a.dispatch('CloseSideBar', { withoutAnimation: !0 }))
              },
              methods: {
                isMobile: function () {
                  return P.getBoundingClientRect().width - 3 < 1024
                },
                resizeHandler: function () {
                  if (!document.hidden) {
                    var t = this.isMobile()
                    K.a.dispatch('ToggleDevice', t ? 'mobile' : 'desktop'),
                      t &&
                        K.a.dispatch('CloseSideBar', { withoutAnimation: !0 })
                  }
                },
          ...
          Object(l.a)(
            ...
            function () {
              ...
              return n(
                ...
                [
                  'mobile' === t.device && t.sidebar.opened
                    ? n('div', {
      ...
      var J = [
          {
            path: '/login',
            component: function () {
              return n.e('chunk-3295').then(n.bind(null, 'ntYl'))
            },
            hidden: !0,
          },
          {
            ...
            children: [
              {
                path: 'dashboard',
                component: function () {
                  return n.e('chunk-5c5a').then(n.bind(null, 'lAbF'))
                },
      ...
      X.options.__file = 'index.vue'
      var q = X.exports
      i.default.component('svg-icon', q)
      !(function (t) {
        t.keys().map(t)
      })(n('Uf/o'))
      var Z = n('Mj6V'),
          ...
          Object(tt.a)()
            ? '/login' === t.path
              ...
              ? K.a
                  ...
                  .catch(function (t) {
                    K.a.dispatch('FedLogOut').then(function () {
                      a.Message.error(
                        t || 'Verification failed, please login again'
                      ),
                        n({ path: '/' })
                    })
                  })
            ...
            : -1 !== et.indexOf(t.path)
            ? n()
            : (n('/login?redirect=' + t.path), W.a.done())
      }),
    ...
    t3Un: function (t, e, n) {
      ...
      var i = n('4d7F'),
        ...
        c = n('Q2AE'),
        l = n('X4fA'),
        u = r.a.create({ baseURL: 'http://bigdata.gmall.com', timeout: 5e3 })
